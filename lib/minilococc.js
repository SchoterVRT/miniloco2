function miniloco(gameName,opgave,xtraText,xtraImage,taal){//taal 0 = NL, 1 = UK
	...
	var tekst1 =
['\n\n\nSleep de bovenste vakjes naar het juiste vakje beneden om een mooi plaatje te maken.\n[Rechts staat een verkleinde versie van dit plaatje.]\n\nAls je het goed hebt gedaan, ontstaat krijg je de complete foto te zien.\n\nDruk op "Reset" om het spel nog een keer te spelen.\n\n\nGemaakt door: Henk Reuling\n(o.a. voor de Wageningse Methode)\n\nNog meer miniloco-spelletjes vind je op:\nhttps://henkreuling.nl\n\nGepubliceerd onder Creative Commons Licentie\nCC BY-NC-SA',
		'\n\n\nDrag the upper tiles to the correct place in the lower grid to create a nice picture.\n[On the right you see a tiny version of this picture.]\n\nIf you made no mistakes, you get to see the whole picture.\n\nPress "Reset" to play again.\nThen you get new questions.\n\n\nMade by: Henk Reuling\n(among other things for "de Wageningse Methode")\n\nMore miniloco-games:\nhttps://henkreuling.nl\n\nPublised under Creative Commons Licence\nCC BY-NC-SA'];
	var tekst2 =
	...
	var fouttekst = ['Nee,\nniet goed.','No,\nnot correct.'];
	var goedtekst = ['Goed gedaan!','Well done!'];
